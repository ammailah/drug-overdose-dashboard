...
with col4:
    ...
    ax.boxplot(data_by_year, tick_labels=years_list)  # ✅ FIXED: 'labels' → 'tick_labels'
...
st.markdown("---")
st.caption("EDA 350 | Instructor: Ali Hassan Sherazi | Submission: 27-May-2026")
down("---")
